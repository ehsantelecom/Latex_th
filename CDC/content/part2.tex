...
\begin{figure}[h!]
\centering
\includegraphics[width=12cm]{content/fig/basic_bb_ofdm.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[width=10cm]{content/fig/osi_ref_mdl.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[width=12cm]{content/fig/practical_bb_ofdm.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[width=10cm]{content/fig/freq_alloc.pdf}
