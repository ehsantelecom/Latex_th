...
\captionof{figure}{System Generator Cycle.}
\label{systemGen}
\end{center}
...
\captionof{figure}{Schimdl and Cox Delay and Correlate Algorithm.}
\label{schimdl_cox}
\end{center}
...
\captionof{figure}{Complex Division Block.}
\label{cmpx_div}
\end{center}

\begin{center}
\includegraphics[width=\textwidth]{content/fig/division.JPG}
\captionof{figure}{Division Block.}
\label{division}
\end{center}
...
\captionof{figure}{ZC706 Evaluation Borad Block Diagram.}
\end{center}
